...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TableFlowGraph = {}));
    ...
    var Toggler = /** @class */ (function () {
        ...
        Toggler.prototype.setActiveIndicator = function () {
            ...
            setStyles(this.indicatorEl, {
                width: this.activeIndex === 0 || this.activeIndex === this.btnList.length - 1
                    ? rect.width - 2 + 'px'
                    : rect.width + 4 + 'px',
    ...
    var TableMask = /** @class */ (function () {
        ...
        TableMask.prototype.submitChange = function () {
            ...
            if (!isEqual(this.resultCellPositionAndSize, targetCellPositionAndSize)) {
                var oldNode = cloneDeep(this.targetCell.nodeData);
    ...
    var LineController = /** @class */ (function () {
        ...
        LineController.prototype.removeLineGroup = function (line) {
            ...
            this.lineAnchorIds = this.lineAnchorIds.filter(function (lines) { return !isEqual(lines, line.anchorIds); });
    ...
    var Anchor = /** @class */ (function () {
        ...
        Anchor.prototype.setPosition = function () {
            var x_left = this.col.offsetLeft + (this.isOffsetX ? 15 : 0);
            var x_center = this.col.offsetLeft + 0.5 * this.col.offsetWidth;
            var x_right = this.col.offsetLeft + this.col.offsetWidth - (this.isOffsetX ? 15 : 0);
            var y_top = this.tr.offsetTop + (this.isOffsetY ? 15 : 0);
            var y_center = this.tr.offsetTop + 0.5 * this.tr.offsetHeight;
            var y_bottom = this.tr.offsetTop + this.tr.offsetHeight - (this.isOffsetY ? 15 : 0);
            switch (this.bearing) {
                case 'topleft':
    ...
    var TableFlowGraph = /** @class */ (function () {
        ...
        TableFlowGraph.prototype.onResize = function () {
            var _this = this;
            debounce$1(function () { return _this.anchorController.resetPosition(); }, 500);
        };
