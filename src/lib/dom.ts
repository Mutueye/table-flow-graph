...
const elMatches = typeof Element !== 'undefined' && (Element.prototype.matches || Element.prototype.webkitMatchesSelector);
...
export function queryChildren(element:HTMLElement, selector:string):HTMLElement[] {
  return Array.prototype.filter.call(element.children, (child:HTMLElement) => matches(child, selector));
}
